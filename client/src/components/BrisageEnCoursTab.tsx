...
interface BrisageEnCoursTabProps {
  inProgressList: EquipmentItem[]
...
export function BrisageEnCoursTab({
  inProgressList,
  resources,
  resourcePrices,
  brisageCoefs,
  ...
  onToggleInProgress,
  onOpenModal,
}: BrisageEnCoursTabProps) {
  if (inProgressList.length === 0) return <p className="empty">Aucun item en cours de brisage.</p>
